...
#define hal_debug_tx hal_io_PC_6
#define hal_debug_rx hal_io_PC_7
...
//#use rs232(baud=57600,parity=N,xmit=hal_com1_tx,bits=8,stream=hal_stream_com1)
...
{
	/* adc settings */
	//hal_debug_printf("HAL: starting adc.\r");
	/* setup interruptions */
	hal_debug_printf("HAL: setting up interruptions.\r\n");
	...
	hal_debug_printf("HAL: start complete.\r");
}
